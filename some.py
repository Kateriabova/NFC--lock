...
class Kabinet(QMainWindow):
    def __init__(self, teacher_email, information={'number': '509', 'foto': '509.png'}):
        super().__init__()
        self.information = information
        self.teacher_email = teacher_email
        uic.loadUi('kab.ui', self)
        self.number.setText(information['number'])
    ...
    def access(self):
        self.acs = Access(self.teacher_email)
        self.acs.show()
